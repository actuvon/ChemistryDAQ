| Comp. #     | Name                           | Desc                                                    | Connections | Diagrams | URL                                                |
| ----------- | ------------------------------ | ------------------------------------------------------- | ----------- | -------- | -------------------------------------------------- |
| **C1**      | **Motherboard**                | Main proto-board, hosts electronic modules/MCUs         |             |          |                                                    |
|             |                                |                                                         |             |          |                                                    |
| **C1-1**    | **Arduino Nano**               | Acts as the ADC                                         |             |          | https://store-usa.arduino.cc/products/arduino-nano |
| C1-1:0      | USB Port                       |                                                         |             |          |                                                    |
...
| C1-2-1-1    | Amplifier Module               | AD620 amplifier module                                  |             |          |                                                    |
...
| C1-2-2-1    | Amplifier Module               | AD620 amplifier module                                  |             |          |                                                    |
...
| C1-2-3-1    | Amplifier Module               | AD620 amplifier module                                  |             |          |                                                    |
...
| C1-2-4-1    | Amplifier Module               | AD620 amplifier module                                  |             |          |                                                    |
